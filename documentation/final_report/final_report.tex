...
\author{Team Gamma \\ {\small \href{https://github.com/ajdafrankovic}{@ajdafrankovic}, \href{https://github.com/akulakul}{@akulakul}, \href{https://github.com/drobilc}{@drobilc}}}
\title{MatchMaker}
\date{}
\begin{document}
	...
	In this section, the implementation of the algorithms explained in section \ref{methods} will be discussed. To solve our task, architecture, presented in figure \ref{fig:final_architecture}, was designed. We tried to keep the entire project as modular as possible, not only because this is the \texttt{ROS} operating system's philosophy, but also because three different people needed to work on the same project at once. \\
	...
	\section{Results}
	In this chapter we discuss how the final presentation went and how our detectors and classifiers performed.
