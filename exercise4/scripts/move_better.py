...
if __name__ == '__main__':
	...
	# to new goals
	mind = Mind([
		{'position': {'x': -1.513, 'y': 0.426}, 'rotation': {'z': 2.259}},
		{'position': {'x': 0.413, 'y': 0.323}, 'rotation': {'z': 2.387}},
		{'position': {'x': 1.387, 'y': 0.848}, 'rotation': {'z': 2.276}},
		{'position': {'x': 1.713, 'y': 0.496}, 'rotation': {'z': 0.878}},
		{'position': {'x': 1.995, 'y': 0.399}, 'rotation': {'z': -0.660}},
		{'position': {'x': 1.087, 'y': -0.292}, 'rotation': {'z': -0.894}},
	])
