...
\begin{document}
	...
	\begin{figure}[h]
		\centering
		\caption{Delaunay triangulation and exploration goals before (left) and after the hierarhical clustering and moving unreachable ones to reachable position (right)}
