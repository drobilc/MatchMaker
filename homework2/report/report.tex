...
\begin{document}
	...
	% Manjka povezava na robota, robot bo vidu različne osvetlitve, ...
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=.13\linewidth, height=.13\linewidth]{images/test01.jpg}
	...
	To prepare the images for classifiers, we cropped them. We did this so the images only contain the color (object) of interest and not also all the surrounding ones. Circles were cropped to perfect circle form using the Hough transform. Cylinders were cropped to rectangles. Some examples of cropped cylinders are shown below.
	...
	% Smo nardili več kombinacij, kaj je training in kaj je testing
